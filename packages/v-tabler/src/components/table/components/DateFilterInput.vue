        ...
        <div class="space-y-3">
            <div class="flex justify-center">
                <ToggleGroupRoot v-model="operatorValue" type="single" class="flex">
                    <ToggleGroupItem v-for="operatorObj in operators" :key="operatorObj.value"
            ...
            <input :id="inputId" type="date" v-model="value" class="form-inputfield w-full text-default"
